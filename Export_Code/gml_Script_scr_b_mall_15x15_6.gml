...
instance_create_depth(((xx * 16) + 176), ((yy * 16) + 64), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 80), ((yy * 16) + 96), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 144), ((yy * 16) + 176), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 144), ((yy * 16) + 128), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 80), ((yy * 16) + 144), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 96), ((yy * 16) + 127), 0, obj_enemy_spawner_bandit)
