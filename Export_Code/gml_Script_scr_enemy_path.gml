...
if (path_timer >= path_timer_reset)
{
    ...
    if (state == (43 << 0))
        spd = npc_spd_not_alerted[npc_id]
    if (state == (35 << 0) || state == (47 << 0) || state == (50 << 0) || state == (37 << 0))
    ...
    if (state == (7 << 0))
    {
        if (human_state_now == (12 << 0) || human_state_now == (13 << 0) || human_state_now == (15 << 0) || human_state_now == (18 << 0) || human_state_now == (17 << 0) || human_state_now == (16 << 0) || human_state_now == (28 << 0) || human_state_now == (26 << 0) || human_state_now == (14 << 0))
            spd = npc_spd_alerted[npc_id]
    }
