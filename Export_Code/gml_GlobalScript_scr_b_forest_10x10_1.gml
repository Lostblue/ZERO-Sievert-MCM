function scr_b_forest_10x10_1(argument0, argument1) //gml_Script_scr_b_forest_10x10_1
{
    var xx = argument0
    var yy = argument1
    ds_grid_set(grid_fence, (xx + 8), (yy + 6), 1468)
    ds_grid_set(grid_fence, (xx + 9), (yy + 6), 1468)
    ds_grid_set(grid_fence, (xx + 9), (yy + 5), 1468)
    ds_grid_set(grid_fence, (xx + 5), (yy + 6), 1468)
    ds_grid_set(grid_fence, (xx + 4), (yy + 6), 1468)
    ds_grid_set(grid_fence, (xx + 3), (yy + 6), 1468)
    ds_grid_set(grid_fence, (xx + 2), (yy + 6), 1468)
