...
chest_item_rare[a, i] = (k * 35)
i++
chest_item[a, i] = (306 << 0)
chest_item_rare[a, i] = (k * 5)
i++
chest_item[a, i] = (313 << 0)
chest_item_rare[a, i] = (k * 25)
i++
...
chest_item_rare[a, i] = (k * 32)
i++
chest_item[a, i] = (314 << 0)
chest_item_rare[a, i] = (k * 3)
i++
chest_item[a, i] = (312 << 0)
chest_item_rare[a, i] = (k * 20)
i++
chest_item[a, i] = (317 << 0)
chest_item_rare[a, i] = (k * 28)
i++
