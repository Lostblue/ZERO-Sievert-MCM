...
if (_exit == 1)
{
    ...
    with (obj_item)
    {
        if (position == (0 << 0) || position == (1 << 0) || position == (2 << 0) || position == (4 << 0) || position == (5 << 0) || position == (6 << 0) || position == (7 << 0) || position == (8 << 0) || position == (9 << 0) || position == (11 << 0) || position == (12 << 0) || position == (10 << 0))
        {
            ...
            ini_write_real("Inventory", ("mod_0_" + string(global.numero_di_item)), mod_id[(0 << 0)])
            ini_write_real("Inventory", ("mod_1_" + string(global.numero_di_item)), mod_id[(1 << 0)])
            ini_write_real("Inventory", ("mod_3_" + string(global.numero_di_item)), mod_id[(3 << 0)])
            ini_write_real("Inventory", ("mod_2_" + string(global.numero_di_item)), mod_id[(2 << 0)])
            ini_write_real("Inventory", ("mod_5_" + string(global.numero_di_item)), mod_id[(5 << 0)])
            ini_write_real("Inventory", ("mod_6_" + string(global.numero_di_item)), mod_id[(6 << 0)])
            ini_write_real("Inventory", ("mod_4_" + string(global.numero_di_item)), mod_id[(4 << 0)])
            ini_write_real("Inventory", ("mod_7_" + string(global.numero_di_item)), mod_id[(7 << 0)])
            ini_write_real("Inventory", ("mod_8_" + string(global.numero_di_item)), mod_id[(8 << 0)])
            ini_write_real("Inventory", ("mod_9_" + string(global.numero_di_item)), mod_id[(9 << 0)])
            ini_write_real("Inventory", ("mod_10_" + string(global.numero_di_item)), mod_id[(10 << 0)])
        }
    }
    ...
    if (global.am_i_discarding == 1)
    {
        ...
        with (obj_item)
        {
            ...
            if (position == (3 << 0))
            {
                ...
                ini_write_real(("chest_" + string(chest.id)), ("mod_0__N_" + string(chest.quanti_item_effettivi)), mod_id[(0 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_1__N_" + string(chest.quanti_item_effettivi)), mod_id[(1 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_3__N_" + string(chest.quanti_item_effettivi)), mod_id[(3 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_2__N_" + string(chest.quanti_item_effettivi)), mod_id[(2 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_5__N_" + string(chest.quanti_item_effettivi)), mod_id[(5 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_6__N_" + string(chest.quanti_item_effettivi)), mod_id[(6 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_4__N_" + string(chest.quanti_item_effettivi)), mod_id[(4 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_7__N_" + string(chest.quanti_item_effettivi)), mod_id[(7 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_8__N_" + string(chest.quanti_item_effettivi)), mod_id[(8 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_9__N_" + string(chest.quanti_item_effettivi)), mod_id[(9 << 0)])
                ini_write_real(("chest_" + string(chest.id)), ("mod_10__N_" + string(chest.quanti_item_effettivi)), mod_id[(10 << 0)])
        ...
        if instance_exists(obj_chest_general)
        {
            ...
            with (obj_item)
            {
                ...
                if (position == (3 << 0))
                {
                    ...
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_0__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(0 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_1__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(1 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_3__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(3 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_2__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(2 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_5__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(5 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_6__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(6 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_4__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(4 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_7__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(7 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_8__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(8 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_9__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(9 << 0)])
                    ini_write_real(("chest_" + string(chest_nearest.id)), ("mod_10__N_" + string(chest_nearest.quanti_item_effettivi)), mod_id[(10 << 0)])
