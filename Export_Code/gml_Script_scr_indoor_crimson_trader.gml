...
scr_place_obj_map(318, ((xx * 16) + 112), ((yy * 16) + 96))
scr_place_obj_map(318, ((xx * 16) + 16), ((yy * 16) + 96))
scr_place_obj_map(318, ((xx * 16) + 22), ((yy * 16) + 25))
scr_place_obj_map(318, ((xx * 16) + 104), ((yy * 16) + 25))
scr_place_obj_map(314, ((xx * 16) + 96), ((yy * 16) + 63))
scr_place_obj_map(227, ((xx * 16) + 64), ((yy * 16) + 63))
scr_place_obj_map(235, ((xx * 16) + 32), ((yy * 16) + 63))
scr_place_obj_map(232, ((xx * 16) + 16), ((yy * 16) + 63))
scr_place_obj_map(278, ((xx * 16) + 48), ((yy * 16) + 79))
scr_place_obj_map(279, ((xx * 16) + 16), ((yy * 16) + 79))
scr_place_obj_map(279, ((xx * 16) + 48), ((yy * 16) + 79))
scr_place_obj_map(280, ((xx * 16) + 32), ((yy * 16) + 79))
scr_place_obj_map(317, ((xx * 16) + 64), ((yy * 16) + 79))
instance_create_depth(((xx * 16) + 88), ((yy * 16) + 79), 0, obj_crimson_trader_1)
instance_create_depth(((xx * 16) + 96), ((yy * 16) + 64), 0, obj_solid)
instance_create_depth(((xx * 16) + 80), ((yy * 16) + 64), 0, obj_solid)
instance_create_depth(((xx * 16) + 64), ((yy * 16) + 64), 0, obj_solid)
instance_create_depth(((xx * 16) + 48), ((yy * 16) + 64), 0, obj_solid)
instance_create_depth(((xx * 16) + 32), ((yy * 16) + 64), 0, obj_solid)
instance_create_depth(((xx * 16) + 16), ((yy * 16) + 64), 0, obj_solid)
