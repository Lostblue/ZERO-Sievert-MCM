...
instance_create_depth(((xx * 16) + 96), ((yy * 16) + 144), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 144), ((yy * 16) + 144), 0, obj_enemy_spawner_bandit)
...
instance_create_depth(((xx * 16) + 128), ((yy * 16) + 112), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 80), ((yy * 16) + 80), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 24), ((yy * 16) + 44), 0, obj_chest_medication_box)
instance_create_depth(((xx * 16) + 38), ((yy * 16) + 44), 0, obj_chest_bag)
instance_create_depth(((xx * 16) + 192), ((yy * 16) + 44), 0, obj_chest_bag)
