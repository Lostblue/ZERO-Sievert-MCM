var _a_ammo_id, _a_ammo_qnt, temp_;
...
if keyboard_check_pressed(global.kb_now[(15 << 0)])
{
...
if keyboard_check_pressed(global.kb_now[(16 << 0)])
{
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(17 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(18 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(19 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(20 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(21 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(22 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(7 << 0)])
    {
        action = 1
        if (weapon_slot[weapon_slot_now] != (2 << 0))
        {
...
if (global.change_ammo_now == 1)
{
    ...
    {
        if (!(keyboard_check_pressed(global.kb_now[(23 << 0)])))
...
if (keyboard_check_pressed(global.kb_now[(23 << 0)]) && global.change_ammo_now == 0 && arma_now != (2 << 0) && reloading == 0)
{
...
if (room == r_hub)
{
    if (action == 0)
    {
        if keyboard_check_pressed(global.kb_now[(6 << 0)])
        {
            if (state == 22)
            {
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(13 << 0)])
    {
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(11 << 0)])
    {
        action = 1
...
if place_meeting(x, y, obj_solid)
{
    ...
    if (keyboard_check(vk_control) && keyboard_check_pressed(vk_down))
        y += amount
    if (keyboard_check(vk_control) && keyboard_check_pressed(vk_right))
        x += amount
    if (keyboard_check(vk_control) && keyboard_check_pressed(vk_left))
        x -= amount
}
if (action == 0)
{
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(12 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(24 << 0)])
    {
        action = 1
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(14 << 0)])
    {
        if (headset_now != (0 << 0))
        {
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(8 << 0)])
    {
        if (arma_now != (2 << 0))
        {
...
if (action == 0)
{
    if keyboard_check_pressed(global.kb_now[(9 << 0)])
    {
        if (arma_now != (2 << 0))
        {
