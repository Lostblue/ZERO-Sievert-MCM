...
if (mod_id[weapon_slot_now, mod_pos_] != -1)
{
    ...
    if (mod_type[id_mod_] == (10 << 0))
    {
        ...
        torch_x[weapon_slot_now, mod_pos_] = nx
        torch_y[weapon_slot_now, mod_pos_] = ny
        torch_have[weapon_slot_now, mod_pos_] = 1
        torch_id[weapon_slot_now, mod_pos_] = id_mod_
    }
}
if (_found == 0)
{
    torch_have[weapon_slot_now, mod_pos_] = 0
    torch_on[weapon_slot_now, mod_pos_] = 0
}
