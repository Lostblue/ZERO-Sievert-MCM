...
scr_place_obj_map(247, ((xx * 16) + 84), ((yy * 16) + 47))
scr_place_obj_map(247, ((xx * 16) + 92), ((yy * 16) + 47))
scr_place_obj_map(247, ((xx * 16) + 84), ((yy * 16) + 40))
scr_place_obj_map(247, ((xx * 16) + 92), ((yy * 16) + 40))
scr_place_obj_map(274, ((xx * 16) + 96), ((yy * 16) + 47))
scr_place_obj_map(97, ((xx * 16) + 37), ((yy * 16) + 70))
scr_place_obj_map(97, ((xx * 16) + 23), ((yy * 16) + 74))
scr_place_obj_map(95, ((xx * 16) + 48), ((yy * 16) + 61))
scr_place_obj_map(95, ((xx * 16) + 53), ((yy * 16) + 44))
scr_place_obj_map(100, ((xx * 16) + 32), ((yy * 16) + 64))
instance_create_depth(((xx * 16) + 88), ((yy * 16) + 55), 0, obj_chest_bag)
...
tilemap_set(o.layer_tileset_wall_below_indoor, 529, (xx + 1), (yy + 5))
tilemap_set(o.layer_tileset_wall_below_indoor, 775, (xx + 2), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 533, (xx + 2), (yy + 4))
tilemap_set(o.layer_tileset_wall_below_indoor, 774, (xx + 3), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 469, (xx + 3), (yy + 2))
tilemap_set(o.layer_tileset_wall_below_indoor, 528, (xx + 3), (yy + 3))
tilemap_set(o.layer_tileset_wall_below_indoor, 495, (xx + 3), (yy + 4))
tilemap_set(o.layer_tileset_wall_below_indoor, 775, (xx + 4), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 496, (xx + 4), (yy + 3))
tilemap_set(o.layer_tileset_wall_below_indoor, 774, (xx + 5), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 530, (xx + 5), (yy + 4))
tilemap_set(o.layer_tileset_wall_below_indoor, 775, (xx + 6), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 490, (xx + 6), (yy + 3))
tilemap_set(o.layer_tileset_wall_below_indoor, 496, (xx + 6), (yy + 6))
