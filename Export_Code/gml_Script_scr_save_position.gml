var temp_chest_x, temp_chest_y, temp_chest_n_item, temp_chest_id, temp_chest_item_id, temp_chest_item_x, temp_chest_item_y, temp_chest_item_qnt, temp_chest_item_rotation, temp_chest_item_dur;
