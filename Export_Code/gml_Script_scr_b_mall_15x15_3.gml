...
instance_create_depth(((xx * 16) + 192), ((yy * 16) + 128), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 144), ((yy * 16) + 96), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 48), ((yy * 16) + 128), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 64), ((yy * 16) + 96), 0, obj_enemy_spawner_bandit)
