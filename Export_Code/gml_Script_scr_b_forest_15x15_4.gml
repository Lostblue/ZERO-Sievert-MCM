...
instance_create_depth(((xx * 16) + 119), ((yy * 16) + 132), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 154), ((yy * 16) + 154), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 75), ((yy * 16) + 91), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 136), ((yy * 16) + 105), 0, obj_enemy_spawner_bandit)
