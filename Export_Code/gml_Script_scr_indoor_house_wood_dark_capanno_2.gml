...
scr_place_obj_map(104, ((xx * 16) + 47), ((yy * 16) + 65))
scr_place_obj_map(104, ((xx * 16) + 35), ((yy * 16) + 79))
scr_place_obj_map(104, ((xx * 16) + 21), ((yy * 16) + 75))
scr_place_obj_map(104, ((xx * 16) + 25), ((yy * 16) + 81))
scr_place_obj_map(104, ((xx * 16) + 25), ((yy * 16) + 65))
scr_place_obj_map(104, ((xx * 16) + 38), ((yy * 16) + 70))
scr_place_obj_map(104, ((xx * 16) + 73), ((yy * 16) + 57))
scr_place_obj_map(104, ((xx * 16) + 54), ((yy * 16) + 57))
scr_place_obj_map(104, ((xx * 16) + 45), ((yy * 16) + 52))
scr_place_obj_map(104, ((xx * 16) + 45), ((yy * 16) + 41))
scr_place_obj_map(105, ((xx * 16) + 29), ((yy * 16) + 57))
scr_place_obj_map(113, ((xx * 16) + 96), ((yy * 16) + 47))
scr_place_obj_map(171, ((xx * 16) + 48), ((yy * 16) + 47))
...
tilemap_set(o.layer_tileset_wall_below_indoor, 457, (xx + 1), (yy + 5))
tilemap_set(o.layer_tileset_wall_below_indoor, 490, (xx + 1), (yy + 6))
tilemap_set(o.layer_tileset_wall_below_indoor, 775, (xx + 2), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 774, (xx + 3), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 533, (xx + 3), (yy + 3))
tilemap_set(o.layer_tileset_wall_below_indoor, 460, (xx + 3), (yy + 4))
tilemap_set(o.layer_tileset_wall_below_indoor, 775, (xx + 4), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 534, (xx + 4), (yy + 4))
tilemap_set(o.layer_tileset_wall_below_indoor, 774, (xx + 5), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 461, (xx + 5), (yy + 3))
tilemap_set(o.layer_tileset_wall_below_indoor, 459, (xx + 5), (yy + 5))
tilemap_set(o.layer_tileset_wall_below_indoor, 775, (xx + 6), (yy + 1))
tilemap_set(o.layer_tileset_wall_below_indoor, 463, (xx + 6), (yy + 3))
