...
instance_create_depth(((xx * 16) + 176), ((yy * 16) + 208), 0, obj_enemy_spawner_bandit)
...
instance_create_depth(((xx * 16) + 96), ((yy * 16) + 128), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 48), ((yy * 16) + 144), 0, obj_enemy_spawner_bandit)
instance_create_depth(((xx * 16) + 160), ((yy * 16) + 144), 0, obj_enemy_spawner_bandit)
